...
import datetime
now = list(str(datetime.datetime.now()).split(" ")[1].split(":")[:-1])
class MyGUI:
    ...
    def __init__(self):
        ...
        self.h.set(int(now[0]))
        self.m1 = tkinter.IntVar()
        self.m1.set(int(now[1][0]))
        self.m2= tkinter.IntVar()
        self.m2.set(int(now[1][1]))
        self.sh = tkinter.StringVar()
        self.sh.set(":")
        self.top_frame = tkinter.Frame(self.main_window,bg="black")
        self.middle_frame = tkinter.Frame(self.main_window,bg="red")
        self.left_label = tkinter.Label(self.top_frame,height=8,width=1)
        self.h_label = tkinter.Label(self.top_frame, textvariable = self.h,fg="green",bg="black",height=3,width=4,font=("Helvetica", 25))
        self.sh_label = tkinter.Label(self.top_frame, textvariable = self.sh,fg="green",bg="black",height=3,width=1,font=("Helvetica", 25))
        ...
        self.right_label = tkinter.Label(self.top_frame,height=8,width=1)
        self.top_label = tkinter.Label(self.top_frame,height=1,width=32)
